...
and `e2e/`, Clean Architecture over MediatR, an Angular workspace, and Playwright
page objects. A **command-line tool** runs on a machine with no browser front end,
